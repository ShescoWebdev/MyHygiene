...
function About() {
  return (
    <div className='about1 text-black bg-[#fff5ed] pb-20 md:pb-0 flex flex-col gap-5 justify-between items-center mt-7 md:mt-[-26px] pt-10'>
      ...
      <button className="px-6 mt-7 py-2 bg-blue-500 text-white rounded-4xl border border-blue-500 transition duration-300 hover:bg-transparent hover:text-blue-500 hover:scale-105 cursor-pointer">
            Book Now
          </button>
      </div>
    ...
    <div className='about2 text-black p-10 flex flex-col gap-14 justify-between items-center md:flex-row'>
        ...
        <div className='order-1 md:order-2'>
          ...
          <div className='about3 text-black w-[20rem] md:w-[75rem] m-5 md:m-16 p-10 pb-16 bg-[#f4d171] flex flex-col items-center rounded-4xl gap-5'>
    ...
    <div className='about4 text-black p-10 flex flex-col gap-5 justify-between items-center md:flex-row'>
        <div>
            <h1 className='text-xl md:text-4xl pb-2 font-[410]'>
              <img src="photos/Logo3.png" alt="MyHygiene Logo" width="130" height="50" />
              Our Commitment</h1>
        ...
        <div>
          <img src="/photos/Team1.jpg" alt="MyHygiene"  className='rounded-2xl w-[300px] h-[250px] md:w-[1300px] md:h-[500px]'/>
        </div>
    </div>

        <div className='about3 text-black w-[20rem] md:w-[75rem] m-5 md:m-16 p-10 pb-16 bg-[#f4d171] flex flex-col items-center rounded-4xl gap-5'>
          <h1 className='text-blue-800 text-xl md:text-3xl font-bold text-center'>Location</h1>
          <p className='text-center text-sm md:text-xl leading-relaxed text-blue-800'>You can find us anywhere within Benin City, Edo State, Nigeria. We hope to meet you soon! </p>
          <button className="px-6 py-2 bg-blue-500 text-white rounded-4xl border border-blue-500 transition duration-300 hover:bg-transparent hover:text-blue-500 hover:scale-105 cursor-pointer">
          Book Now
          </button>
            </div>
