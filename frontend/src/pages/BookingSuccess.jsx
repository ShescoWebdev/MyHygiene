      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl text-center border-t-8 border-[#f0b000]">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            Thank you for booking with <strong>MyHygiene</strong>. Your request has been sent. Unfortunately, our email service is currently unavailable, so please check your WhatsApp for a pending confirmation message. Our team will review your booking and get back to you within 24-48 hours. We look forward to providing you with a sparkling clean home!
          </p>
          <Link
            to="/"
